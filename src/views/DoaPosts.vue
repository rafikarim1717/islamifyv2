      ...
      <div class="flex flex-col gap-10 px-5 lg:px-8">
        <nav class="px-5 rounded-md w-full">
          <ol class="list-reset flex">
            ...
            <li>
              <p href="#" class="text-black">Doa Topic</p>
            </li>
          </ol>
        </nav>
        ...
        <div class="">
          <div class="" v-for="post in doaPosts" :key="post.postId">
            <div
...
import { doaPostsCollection, auth } from "@/includes/firebase";
  ...
  methods: {
    ...
    addPost() {
      ...
      if (user !== null) {
        ...
        const docRef = addDoc(doaPostsCollection, {
