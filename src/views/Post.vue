...
<script>
	import TimeSince from '@/components/Utility/TimeSince'
...
.view--post {
 ...
 .view--post .view--post-breadcrumbs {
	 padding: 43px 0;
}
 .view--post .view--post-breadcrumbs ul {
	 margin: 0;
	 padding: 0;
 ...
 .view--post .view--post-breadcrumbs ul li a {
	 text-decoration: none;
	 font-size: 18px;
	 line-height: 27px;
	 color: var(--green-dark);
}
 .view--post .view--post-breadcrumbs ul li a:after {
	 content: '/';
	 margin: 0 20px;
}
 .view--post .view--post-breadcrumbs ul li:last-of-type a {
	 color: #aaa;
	 margin: 0;
}
 .view--post .view--post-breadcrumbs ul li:last-of-type a:after {
	 content: '';
}
 .view--post .view--post-content {
	 display: flex;
	 flex-flow: wrap;
	 padding: 0;
	 color: var(--green-dark);
 ...
 .view--post .view--post-content .view--post-content-wrapper {
	 display: flex;
	 flex-flow: wrap;
}
 .view--post .view--post-content .view--post-content-delete button.delete {
	 background: transparent;
	 color: #d5445e;
	 border-radius: 20px;
	 border: none;
 ...
 .view--post .view--post-content .view--post-content-delete span {
	 font-size: 22px;
	 margin-bottom: -10px;
 ...
 .view--post .view--post-content-avatar {
	 width: 50px;
	 height: 50px;
	 font-size: 20px;
	 line-height: 30px;
 ...
 .view--post .view--post-content-avatar.blue {
	 background: var(--blue);
}
 .view--post .view--post-content-avatar.purple {
	 background: var(--purple);
}
 .view--post .view--post-content-avatar.pink {
	 background: var(--pink);
}
 .view--post .view--post-content-avatar.orange {
	 background: var(--orange);
}
 .view--post .view--post-content-avatar.yellow {
	 background: var(--yellow);
}
 .view--post .view--post-content-details {
	 width: calc(100% - 124px);
}
 .view--post .view--post-content-details .view--post-content-details-title {
	 font-size: 20px;
	 line-height: 26px;
	 font-weight: bold;
	 color: var(--green-dark);
}
 .view--post .view--post-content-details .view--post-content-details-date {
	 font-size: 16px;
	 line-height: 24px;
	 color: var(--green-dark);
	 width: 100%;
}
 .view--post .view--post-content-body {
	 width: 100%;
	 margin: 0;
}
 .view--post .view--post-content-body p {
	 font-size: 16px;
	 line-height: 24px;
}
 ...
 .view--post-content-comments form textarea {
	 resize: none;
	 font-size: 16px;
	 line-height: 24px;
}
 .view--post-content-comments button {
 ...
 .view--post-content-comments h3 {
	 margin: 20px 0;
	 padding: 20px 0 0;
	 border-top: 1px solid #eee;
}
 .view--post-content-comments ul {
	 margin: 0;
	 padding: 0;
	 list-style-type: none;
}
 .view--post-content-comments ul li {
	 display: flex;
	 flex-flow: wrap;
 ...
 .view--post-content-comments ul li:last-of-type {
	 border-bottom: 0;
	 margin-bottom: 0;
}
 .view--post-content-comments ul li .view--post-content-comments-comment {
	 padding: 0;
	 display: flex;
	 flex-flow: wrap;
	 width: 100%;
 ...
 .view--post-content-comments ul li .view--post-content-comments-comment .view--post-content-comments-comment-delete button.delete {
	 background: transparent;
	 color: #d5445e;
	 border-radius: 10px;
	 border: none;
 ...
 .view--post-content-comments ul li .view--post-content-comments-comment .view--post-content-comments-comment-delete button.delete span {
	 font-size: 22px;
	 margin-bottom: -10px;
	 display: inline-block;
	 bottom: -3px;
