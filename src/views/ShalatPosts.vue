      ...
      <div class="flex flex-col gap-10 px-5 lg:px-8">
        <nav class="px-5 rounded-md w-full">
          <ol class="list-reset flex">
            ...
            <li>
              <p href="#" class="text-black">Sholat Topic</p>
            </li>
          </ol>
        </nav>
...
import { shalatPostsCollection, auth } from "@/includes/firebase";
  ...
  methods: {
    ...
    addPost() {
      ...
      if (user !== null) {
        ...
        const docRef = addDoc(shalatPostsCollection, {
    ...
    report(postID) {
      ...
      this.shalatPosts = this.shalatPosts.map((post) => {
