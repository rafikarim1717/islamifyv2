      ...
      <div class="flex flex-col gap-10 px-5 lg:px-8">
        <nav class="px-5 rounded-md w-full">
          <ol class="list-reset flex">
            ...
            <li>
              <p href="#" class="text-black">Hadist Topic</p>
            </li>
          </ol>
        </nav>
        ...
        <div class="">
          <div class="" v-for="post in hadistPosts" :key="post.postId">
            <div
            ...
            >
              <div class="flex justify-between mb-2">
                <div class="flex items-center">
                  <img
                    ...
                    alt="Author Photo"
                    class="hidden object-cover w-10 h-10 mr-2 rounded-full sm:block"
                  />
                  <a class="font-bold text-black text-lg cursor-pointer">{{
                    post.users
                  }}</a>
                </div>
                <div class="flex flex-row gap-1" @click="toggleReport()">
              ...
              <div class="mt-2 max-w-xs md:max-w-xl">
...
import { hadistPostsCollection, auth } from "@/includes/firebase";
  ...
  methods: {
    ...
    addPost() {
      ...
      if (user !== null) {
        ...
        const docRef = addDoc(hadistPostsCollection, {
